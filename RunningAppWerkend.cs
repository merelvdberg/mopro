    ...
    public class MainActivity : Activity
    {
        ...
        public class RunningView : View, ILocationListener, ISensorEventListener
        {
            ...
            public void Faken()
            {
                ...
                route.Add(new Meting(new DateTime(2018, 1, 17, 16, 19, 25), new PointF(140217, 455840)));
                route.Add(new Meting(new DateTime(2018, 1, 17, 16, 19, 31), new PointF(140225, 455841)));
                route.Add(new Meting(new DateTime(2018, 1, 17, 16, 19, 37), new PointF(140233, 455840)));
                route.Add(new Meting(new DateTime(2018, 1, 17, 16, 19, 42), new PointF(140241, 455841)));
                route.Add(new Meting(new DateTime(2018, 1, 17, 16, 19, 46), new PointF(140251, 455840)));
                route.Add(new Meting(new DateTime(2018, 1, 17, 16, 19, 50), new PointF(140261, 455839)));
                route.Add(new Meting(new DateTime(2018, 1, 17, 16, 19, 53), new PointF(140270, 455838)));
                route.Add(new Meting(new DateTime(2018, 1, 17, 16, 19, 55), new PointF(140276, 455838)));
                route.Add(new Meting(new DateTime(2018, 1, 17, 16, 19, 57), new PointF(140282, 455839)));
                route.Add(new Meting(new DateTime(2018, 1, 17, 16, 19, 59), new PointF(140286, 455839)));
                route.Add(new Meting(new DateTime(2018, 1, 17, 16, 20, 2), new PointF(140291, 455839)));
                route.Add(new Meting(new DateTime(2018, 1, 17, 16, 20, 7), new PointF(140299, 455838)));
                route.Add(new Meting(new DateTime(2018, 1, 17, 16, 20, 11), new PointF(140306, 455838)));
                route.Add(new Meting(new DateTime(2018, 1, 17, 16, 20, 16), new PointF(140311, 455834)));
                route.Add(new Meting(new DateTime(2018, 1, 17, 16, 20, 21), new PointF(140318, 455833)));
                route.Add(new Meting(new DateTime(2018, 1, 17, 16, 20, 26), new PointF(140324, 455831)));
                route.Add(new Meting(new DateTime(2018, 1, 17, 16, 20, 28), new PointF(140327, 455832)));
                route.Add(new Meting(new DateTime(2018, 1, 17, 16, 20, 30), new PointF(140330, 455831)));
                route.Add(new Meting(new DateTime(2018, 1, 17, 16, 20, 35), new PointF(140328, 455829)));
