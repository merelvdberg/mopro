...
namespace Lab3
{
	public class Ticketautomaat : Form
	{
		ComboBox fromBox;
		ComboBox toBox;
        ...
        private void definitievePrijs(TicketautomaatInvoer info)
        {
            ...
            Database.addTracks();
            int tariefeenheden = Database.getTariefeenheden(Database.alleTracks, info.From, info.To);
            //Track t = new Track();
            //tariefeenheden = Track.getTariefeenheden();
...
#region Set-up -- don't look at it
		private void initializeControls()
		{
			...
			// Set up event
			pay.Click += (object sender, EventArgs e) => definitievePrijs(getUIInfo());
		}

		private TicketautomaatInvoer getUIInfo()
		{
			UIClass cls;
			...
			return new TicketautomaatInvoer ((string)fromBox.SelectedItem,
